...
(function(global, _this) {
    ...
    // Keep a copy of the simpli object in the previous context
    var noConflictSimpli = _this.simpli;
    ...
    simpli.version = "1.2.4";

    /** 
     * Relinquish the simpli variable
     * @return {object}     Returns the simpli object
     */
    simpli.noConflict = function() {
        _this.simpli = noConflictSimpli;
        return simpli;
    }
     ...
     * This function wrap and return the console object according to the 
     * current environment support
     * @return {object}     Returns the console object
     * @memberof simpli
     */
    ...
    // copy local simpli to global context
    _this.simpli = simpli;

    // Compatible with Node.js module
    if(typeof exports !== 'undefined') {
        if(typeof module !== 'undefined' && module.exports) {
            exports = module.exports = simpli;
        }
        exports.simpli = simpli;
    }
})(typeof window === "undefined"? global: window, this);
